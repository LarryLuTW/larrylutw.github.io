...
在開始之前先澄清一下，__VSCode__ 跟微軟那套 __Visual Studio__ 一點關係都沒有，而且 <a href="https://github.com/Microsoft/vscode" target="_blank">VSCode</a> 是完全開源的，社群也非常活絡。
...
不用擔心 code 排版太醜，VSCode 可以自動幫你排版
